describe("Core htmx client side validation tests", function () {
  ...
  it("HTML5 required validation error prevents request", function () {
    ...
    var form = make(
      '<form hx-post="/test" hx-trigger="click">' + "No Request" + '<input id="i1" name="i1" required>' + "</form>"
    );
  ...
  it("Novalidate skips form validation", function () {
    ...
    var form = make(
      '<form hx-post="/test" hx-trigger="click" novalidate>' +
        "No Request" +
  ...
  it("Custom validation error prevents request", function () {
    ...
    var form = make(
      '<form hx-post="/test" hx-trigger="click">' + "No Request" + '<input id="i1" name="i1">' + "</form>"
    );
  ...
  it("hx-validate can prevent a single input from submitting", function () {
    ...
    var form = make(
      '<form><input type="text" hx-target="#d1" hx-post="/test" hx-trigger="click" id="i1" name="i1" pattern="[0-9]+" hx-validate="true"/></form>'
    );
    var input = byId("i1");
