describe("hx-ext attribute", function () {
  ...
  it("Extensions are merged properly", function () {
    ...
    make(
      '<div hx-ext="ext-1"><button id="btn-1" hx-get="/test" hx-ext="ext-2">Click Me!</button>' +
  ...
  it("Extensions are ignored properly", function () {
    ...
    make(
      '<div id="div-AA" hx-ext="ext-1, ext-2"><button id="btn-AA" hx-get="/test">Click Me!</button>' +
