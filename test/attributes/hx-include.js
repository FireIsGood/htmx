describe("hx-include attribute", function () {
  ...
  it("By default an input includes itself", function () {
    ...
    var div = make(
      '<div hx-target="this"><input hx-post="/include" hx-trigger="click" id="i1" name="i1" value="test"/></div>'
    );
    var input = byId("i1");
    input.click();
    this.server.respond();
  ...
  it("non-GET includes closest form", function () {
    ...
    var div = make(
      '<form hx-target="this"><div id="d1" hx-post="/include"></div><input name="i1" value="test"/></form>'
    );
    var input = byId("d1");
    input.click();
    this.server.respond();
  ...
  it("GET does not include closest form by default", function () {
    ...
    var div = make(
      '<form hx-target="this"><div id="d1" hx-get="/include"></div><input name="i1" value="test"/></form>'
    );
    var input = byId("d1");
    input.click();
    this.server.respond();
  ...
  it("Single input not included twice when in form", function () {
    ...
    var div = make(
      '<form hx-target="this"><input hx-post="/include" hx-trigger="click" id="i1" name="i1" value="test"/></form>'
    );
    var input = byId("i1");
    input.click();
    this.server.respond();
  ...
  it("A form can be referred to externally", function () {
    ...
    make('<form id="f1">' + '<input name="i1" value="test"/>' + '<input  name="i2" value="test"/>' + "</form> ");
  ...
  it("By default an input includes itself w/ data-* prefix", function () {
    ...
    var div = make(
      '<div data-hx-target="this"><input data-hx-post="/include" data-hx-trigger="click" id="i1" name="i1" value="test"/></div>'
    );
    var input = byId("i1");
    input.click();
    this.server.respond();
  ...
  it("The `closest` modifier can be used in the hx-include selector", function () {
    ...
    make(
      '<div id="i"><input name="i1" value="test"/><input name="i2" value="test"/>' +
  ...
  it("The `this` modifier can be used in the hx-include selector", function () {
    ...
    make(
      '<div id="i" hx-include="this"><input name="i1" value="test"/><input name="i2" value="test"/>' +
