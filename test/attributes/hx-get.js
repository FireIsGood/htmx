describe("hx-get attribute", function () {
  ...
  it("GET on form with existing parameters works properly", function () {
    ...
    var form = make(
      '<form hx-trigger="click" hx-get="/test?foo=bar"><input name="i1" value="value"/><button id="b1">Click Me!</button></form>'
    );
    form.click();
    this.server.respond();
    form.innerHTML.should.equal("Clicked!");
  ...
  it("GET on form with anchor works properly", function () {
    ...
    var form = make(
      '<form hx-trigger="click" hx-get="/test?foo=bar#foo"><input name="i1" value="value"/><button id="b1">Click Me!</button></form>'
    );
    form.click();
    this.server.respond();
    form.innerHTML.should.equal("Clicked!");
