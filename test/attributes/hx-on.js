describe("hx-on attribute", function () {
  ...
  it("can modify a parameter via htmx:configRequest", function () {
    ...
    var btn = make(
      "<button hx-on='htmx:configRequest: event.detail.parameters.foo = \"bar\"' hx-post='/test'>Foo</button>"
    );
    btn.click();
    this.server.respond();
  ...
  it("can cancel an event via preventDefault for htmx:configRequest", function () {
    ...
    var btn = make(
      "<button hx-on='htmx:configRequest: event.preventDefault()' hx-post='/test' hx-swap='outerHTML'>Foo</button>"
    );
    btn.click();
    this.server.respond();
