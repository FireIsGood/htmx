describe("hx-sync attribute", function () {
  ...
  it("can use drop strategy", function () {
    ...
    make(
      '<div hx-sync="this:drop"><button id="b1" hx-get="/test">Initial</button>' +
  ...
  it("defaults to the drop strategy", function () {
    ...
    make(
      '<div hx-sync="this"><button id="b1" hx-get="/test">Initial</button>' +
        '                                      <button id="b2" hx-get="/test">Initial</button></div>'
    );
    var b1 = byId("b1");
    var b2 = byId("b2");
  ...
  it("can use replace strategy", function () {
    ...
    make(
      '<div hx-sync="this:replace"><button id="b1" hx-get="/test">Initial</button>' +
        '                                      <button id="b2" hx-get="/test">Initial</button></div>'
    );
    var b1 = byId("b1");
    var b2 = byId("b2");
  ...
  it("can use queue all strategy", function () {
    ...
    make(
      '<div hx-sync="this:queue all"><button id="b1" hx-get="/test">Initial</button>' +
  ...
  it("can use queue last strategy", function () {
    ...
    make(
      '<div hx-sync="this:queue last"><button id="b1" hx-get="/test">Initial</button>' +
        '                                      <button id="b2" hx-get="/test">Initial</button>' +
        '                                      <button id="b3" hx-get="/test">Initial</button></div>'
    );
    var b1 = byId("b1");
  ...
  it("can use queue first strategy", function () {
    ...
    make(
      '<div hx-sync="this:queue first"><button id="b1" hx-get="/test">Initial</button>' +
        '                                      <button id="b2" hx-get="/test">Initial</button>' +
        '                                      <button id="b3" hx-get="/test">Initial</button></div>'
    );
    var b1 = byId("b1");
  ...
  it("can use abort strategy to end existing abortable request", function () {
    ...
    make(
      '<div hx-sync="this"><button hx-sync="closest div:abort" id="b1" hx-get="/test">Initial</button>' +
        '                                      <button id="b2" hx-get="/test">Initial</button></div>'
    );
    var b1 = byId("b1");
    var b2 = byId("b2");
  ...
  it("can abort a request programmatically", function () {
    ...
    make(
      '<div><button id="b1" hx-get="/test">Initial</button>' +
        '             <button id="b2" hx-get="/test">Initial</button></div>'
    );
    var b1 = byId("b1");
    var b2 = byId("b2");
