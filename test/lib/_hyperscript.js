    ...
    _parser.addLeafExpression("queryRef", function (parser, runtime, tokens) {
      ...
      return {
        ...
        op: function (context, args) {
          ...
          runtime.forEach(elements, function (el) {
            el.removeAttribute("data-hs-query-id");
          });
          return result;
        },
        evaluate: function (context) {
          ...
          runtime.unifiedEval(
            {
              ...
              op: function (ctx, args) {
                ...
                if (!(behavior instanceof Function)) throw new Error(behaviorPath + " is not a behavior");
        ...
        op: function (context, root, valueToPut) {
          if (symbolWrite) {
            ...
            if (operation === "into") {
              ...
              runtime.forEach(root, function (elt) {
                op.call(elt, valueToPut instanceof Node ? valueToPut : runtime.convertValue(valueToPut, "Fragment"));
              });
            }
          }
          return runtime.findNext(this, context);
