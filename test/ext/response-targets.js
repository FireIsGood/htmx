describe("response-targets extension", function () {
  ...
  it("targets a parent element properly", function () {
    this.server.respondWith("GET", "/test", [404, {}, "Not found!"]);
    var div1 = make(
      '<div hx-ext="response-targets" id="d1"><button id="b1" hx-target-404="#d1" hx-get="/test">Click Me!</button></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("targets a parent element properly with wildcard", function () {
    this.server.respondWith("GET", "/test", [404, {}, "Not found!"]);
    var div1 = make(
      '<div hx-ext="response-targets" id="d1"><button id="b1" hx-target-*="#d1" hx-get="/test">Click Me!</button></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("targets a `this` element properly", function () {
    this.server.respondWith("GET", "/test", [404, {}, "Not found!"]);
    var div1 = make(
      '<div hx-ext="response-targets" hx-target-404="this"><button id="b1" hx-get="/test">Click Me!</button></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("targets a `closest` element properly", function () {
    this.server.respondWith("GET", "/test", [404, {}, "Not found!"]);
    var div1 = make(
      '<div hx-ext="response-targets"><p><i><button id="b1" hx-target-404="closest div" hx-get="/test">Click Me!</button></i></p></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("targets a `find` element properly", function () {
    this.server.respondWith("GET", "/test", [404, {}, "Not found!"]);
    var div1 = make(
      '<div hx-ext="response-targets" hx-target-404="find span" hx-get="/test">Click Me! <div><span id="s1"></span><span id="s2"></span></div></div>'
    );
    div1.click();
    this.server.respond();
    var span1 = byId("s1");
  ...
  it("targets an inner element properly", function () {
    this.server.respondWith("GET", "/test", [404, {}, "Not found!"]);
    var btn = make(
      '<button hx-ext="response-targets" hx-target-404="#d1" hx-get="/test">Click Me!<div id="d1"></div></button>'
    );
    var div1 = byId("d1");
    btn.click();
    this.server.respond();
