describe("hx-boost attribute", function () {
  ...
  it("handles basic form post properly", function () {
    ...
    var div = make(
      '<div hx-target="this" hx-boost="true"><form id="f1" action="/test" method="post"><button id="b1">Submit</button></form></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("handles basic form post with button formaction properly", function () {
    this.server.respondWith("POST", "/test", "Boosted");
    var div = make(
      '<div hx-target="this" hx-boost="true"><form id="f1" method="post"><button id="b1" formaction="/test">Submit</button></form></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("handles basic form post with button formmethod properly", function () {
    this.server.respondWith("POST", "/test", "Boosted");
    var div = make(
      '<div hx-target="this" hx-boost="true"><form id="f1" action="/test"><button id="b1" formmethod="post">Submit</button></form></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("handles basic form post properly w/ explicit action", function () {
    this.server.respondWith("POST", "/test", "Boosted");
    var div = make(
      '<div hx-target="this"><form id="f1" action="/test" method="post"  hx-trigger="click" hx-boost="true"></form></div>'
    );
    var form = byId("f1");
    form.click();
    this.server.respond();
  ...
  it("handles basic form get properly", function () {
    this.server.respondWith("GET", "/test", "Boosted");
    var div = make(
      '<div hx-target="this" hx-boost="true"><form id="f1" action="/test" method="get"><button id="b1">Submit</button></form></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
  ...
  it("handles basic form with no explicit method property", function () {
    this.server.respondWith("GET", "/test", "Boosted");
    var div = make(
      '<div hx-target="this" hx-boost="true"><form id="f1" action="/test"><button id="b1">Submit</button></form></div>'
    );
    var btn = byId("b1");
    btn.click();
    this.server.respond();
