describe("hx-sse attribute", function () {
  ...
  it("does not trigger events that arent named", function () {
    ...
    var div = make(
      '<div hx-sse="connect:/foo">' + '<div id="d1" hx-trigger="sse:e1" hx-get="/d1">div1</div>' + "</div>"
    );
  ...
  it("does not trigger events not on descendents", function () {
    ...
    var div = make('<div hx-sse="connect:/foo"></div>' + '<div id="d1" hx-trigger="sse:e1" hx-get="/d1">div1</div>');
  ...
  it("is closed after removal", function () {
    ...
    var div = make(
      '<div hx-get="/test" hx-swap="outerHTML" hx-sse="connect:/foo">' +
        '<div id="d1" hx-trigger="sse:e1" hx-get="/d1">div1</div>' +
        "</div>"
    );
    div.click();
