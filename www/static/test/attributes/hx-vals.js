describe("hx-vals attribute", function () {
  ...
  it("hx-vals overrides inputs", function () {
    ...
    var div = make(
      "<div hx-target='this'><input hx-post='/include' hx-vals='\"i1\":\"best\"' hx-trigger='click' id='i1' name='i1' value='test'/></div>"
    );
    var input = byId("i1");
    input.click();
    this.server.respond();
  ...
  it("hx-vals can override parents", function () {
    ...
    make(
      '<div hx-vals="javascript:i1:\'test\'"><div id="d1" hx-vals="javascript:i1:\'best\'" hx-post="/vars"></div></div>'
    );
    var div = byId("d1");
    div.click();
    this.server.respond();
  ...
  it("hx-vals overrides inputs", function () {
    ...
    var div = make(
      '<div hx-target="this"><input hx-post="/include" hx-vals="javascript:i1:\'best\'" hx-trigger="click" id="i1" name="i1" value="test"/></div>'
    );
    var input = byId("i1");
    input.click();
    this.server.respond();
