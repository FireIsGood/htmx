describe("hx-headers attribute", function () {
  ...
  it("hx-headers overrides inputs", function () {
    ...
    var div = make(
      "<div hx-target='this'><input hx-post='/include' hx-headers='\"i1\":\"best\"' hx-trigger='click' id='i1' name='i1' value='test'/></div>"
    );
    var input = byId("i1");
    input.click();
    this.server.respond();
  ...
  it("hx-headers can override parents", function () {
    ...
    make(
      '<div hx-headers="javascript:i1:\'test\'"><div id="d1" hx-headers="javascript:i1:\'best\'" hx-post="/vars"></div></div>'
    );
    var div = byId("d1");
    div.click();
    this.server.respond();
  ...
  it("hx-headers overrides inputs", function () {
    ...
    var div = make(
      '<div hx-target="this"><input hx-post="/include" hx-headers="javascript:i1:\'best\'" hx-trigger="click" id="i1" name="i1" value="test"/></div>'
    );
    var input = byId("i1");
    input.click();
    this.server.respond();
