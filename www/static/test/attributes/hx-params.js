describe("hx-params attribute", function () {
  ...
  it("none excludes all params", function () {
    ...
    var form = make(
      '<form hx-trigger="click" hx-post="/params" hx-params="none">' +
  ...
  it('"*" includes all params', function () {
    ...
    var form = make(
      '<form hx-trigger="click" hx-post="/params" hx-params="*">' +
        '<input name="i1" value="test"/>' +
        '<input  name="i2" value="test"/>' +
        '<input  name="i3" value="test"/>' +
        "</form> "
  ...
  it("named includes works", function () {
    ...
    var form = make(
      '<form hx-trigger="click" hx-post="/params" hx-params="i1, i3">' +
        '<input name="i1" value="test"/>' +
        '<input  name="i2" value="test"/>' +
        '<input  name="i3" value="test"/>' +
        "</form> "
  ...
  it("named exclude works", function () {
    ...
    var form = make(
      '<form hx-trigger="click" hx-post="/params" hx-params="not i1, i3">' +
        '<input name="i1" value="test"/>' +
        '<input  name="i2" value="test"/>' +
        '<input  name="i3" value="test"/>' +
        "</form> "
  ...
  it("named exclude works  w/ data-* prefix", function () {
    ...
    var form = make(
      '<form data-hx-trigger="click" data-hx-post="/params" data-hx-params="not i1, i3">' +
        '<input name="i1" value="test"/>' +
        '<input  name="i2" value="test"/>' +
        '<input  name="i3" value="test"/>' +
        "</form> "
