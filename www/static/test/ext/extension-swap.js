describe("default extensions behavior", function () {
  ...
  it("handleSwap: new content is handled by htmx", function () {
    this.server.respondWith(
      "GET",
      "/test",
      '<button id="test-ext-testswap">Clicked!<span hx-get="/test-inner" hx-trigger="load"></span></button>'
    );
    this.server.respondWith("GET", "/test-inner", "Loaded!");
    make('<div hx-ext="ext-testswap"><button hx-get="/test" hx-swap="testswap">Click Me!</button></div>')
