describe("disable-element extension", function () {
  ...
  it("disables the designated element during htmx request", function () {
    ...
    var btn = make(
      '<button hx-get="/test" hx-ext="disable-element" hx-disable-element="#should-be-disabled">Click Me!</button>'
    );
  ...
  it("disables multiple elements during htmx request", function () {
    ...
    var btn = make(
      '<button class="should-be-disabled" hx-get="/test" hx-ext="disable-element" hx-disable-element=".should-be-disabled">Click Me!</button>'
    );
